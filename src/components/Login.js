    ...
    <div>
      ...
      <div>
        <form className='absolute p-12 bg-black w-3/12 my-36 mx-auto right-0 left-0 text-white rounded-lg bg-opacity-80' >
          ...
          <button className="p-4 my-6 bg-red-700 font-bold w-full rounded-lg">Sign In</button>
          <p className="text-center">Or </p>
          <h1 className="font-bold  p-2 m-2 w-full"> New to Netflix? <span className='hover:cursor-pointer text-red-700'>Sign Up Now</span></h1>
